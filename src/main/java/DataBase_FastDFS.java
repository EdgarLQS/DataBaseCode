...
//        System.out.println("=====GroupID: " + fileIds[0] + " =====filepath: " + fileIds[1] );
    ...
    public static void main(String[] args) {
        ...
        String path = "E:\\DemoRecording\\testFileStorage\\JerseyTest\\test1.jpg";
        // 上传文件
        byte[] data = new Utils().fileToByte(path);

        String fileExtName = "AA1118888A" + path.substring(path.lastIndexOf('.')+1) ;
        ...
        downloadlist.add("E:\\DemoRecording\\testFileStorage\\JerseyTest\\FastDFSdownloadtest" + "." + fileExtName);
